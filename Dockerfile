...
RUN cd /xuexi/; \
  ...
  dpkg -i google-chrome-stable_108.0.5359.71_amd64.deb; \
  apt-get -fy install; \
  google-chrome --version; \
  rm -f google-chrome-stable_108.0.5359.71_amd64.deb
RUN cd /xuexi/; \
  wget -O chromedriver_linux64_108.0.5359.71.zip http://npm.taobao.org/mirrors/chromedriver/108.0.5359.71/chromedriver_linux64.zip; \
