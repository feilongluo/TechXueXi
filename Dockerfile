...
ARG usesource="https://github.com/feilongluo/TechXueXi.git"
ARG usebranche="dev"
...
RUN cd /xuexi/; \
  wget https://dl.google.com/linux/chrome/deb/pool/main/g/google-chrome-stable/google-chrome-stable_108.0.5359.98-1_amd64.deb; \
  dpkg -i google-chrome-stable_108.0.5359.98-1_amd64.deb; \
  apt-get -fy install; \
  google-chrome --version; \
  rm -f google-chrome-stable_108.0.5359.98-1_amd64.deb
RUN cd /xuexi/; \
  wget -O chromedriver_linux64_108.0.5359.71.zip https://chromedriver.storage.googleapis.com/108.0.5359.71/chromedriver_linux64.zip; \
  unzip chromedriver_linux64_108.0.5359.71.zip; \
